...
public class BasePane extends Pane {
    ...
    public BasePane(ComboBox<Speaker> combobox, TextArea textarea, ImageView addButton, CheckBox checkBox, Pane timeCode) {
        ...
        this.getChildren().addAll(combobox, p, checkBox, timeCode, addButton, add);
